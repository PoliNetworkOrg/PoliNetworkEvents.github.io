...
const logger = consola.consola.withTag("@nuxt/telemetry");
...
async function ensureUserconsent(options) {
  ...
  consola.consola.info(`${c__default["default"].green("NuxtJS")} collects completely anonymous data about usage.
